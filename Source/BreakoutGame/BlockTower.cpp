...
#include "BlockTower.h"
#include "DestructibleComponent.h"
#include "Kismet/GameplayStatics.h"

ABlockTower::ABlockTower()
{
	
}

void ABlockTower::BeginPlay()
{
	Super::BeginPlay();
...
void ABlockTower::OnMyActorFracture(const FVector& HitPoint, const FVector& HitDirection)
{
	...
	GetWorld()->GetTimerManager().SetTimer(FractureTimerHandle, this, &ABlockTower::DestroyActor, FractureTimerDelay, false);
}

void ABlockTower::DestroyActor()
{
	Destroy();
}
